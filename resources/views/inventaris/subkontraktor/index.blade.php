                  ...
                  <div class="container">
                    <div style="border-radius:30px" class="card shadow-lg p-3 rounded-pill-4">
                      <div class="container-fluid">
                        ...
                        <div class="btn-i">
                          <a style="border-radius:10px; padding:8px" class="btn btn-secondary btn-sm" href="{{url('show_subkontraktor')}}"><i class="fa-solid fa-plus" data-feather="plus">></i> Tambah Data</a>
                        </div>
                            <p></p>
                        </div>
                            <div class="table-responsive">
                              <table class="table" style="text-align: center">
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                    ...
                                    <td>{{$subkontraktor->stock}}</td>
                                    <td>
                                      <a class="btn-edit" href='{{ url('edit_sub',$subkontraktor->id) }}' title="Edit"><i class="fa-regular fa-pen-to-square" data-feather="edit"></i></a>
                                      <a onclick="confirmation(event)" class="btn-hapus" href="{{url('delete_sub',$subkontraktor->id)}}" title="Hapus"><i class="fa-solid fa-trash" data-feather="trash-2"></i></a>
                                    </td>
                                  </tr>
                                  @endforeach
                                </tbody>
